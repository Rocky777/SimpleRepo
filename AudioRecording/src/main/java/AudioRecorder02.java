...
class CaptureThread extends Thread{
  public void run(){
    ...
    if(aifcBtn.isSelected()){
      ...
      audioFile = new File("C:/Users/Rocky/Desktop/junk.aifc");
    }else if(aiffBtn.isSelected()){
      fileType = AudioFileFormat.Type.AIFF;
      audioFile = new File("C:/Users/Rocky/Desktop/junk.aif");
    }else if(auBtn.isSelected()){
      fileType = AudioFileFormat.Type.AU;
      audioFile = new File("C:/Users/Rocky/Desktop/junk.au");
    }else if(sndBtn.isSelected()){
      fileType = AudioFileFormat.Type.SND;
      audioFile = new File("C:/Users/Rocky/Desktop/junk.snd");
    }else if(waveBtn.isSelected()){
      fileType = AudioFileFormat.Type.WAVE;
      audioFile = new File("C:/Users/Rocky/Desktop/junk.wav");
    }//end if
